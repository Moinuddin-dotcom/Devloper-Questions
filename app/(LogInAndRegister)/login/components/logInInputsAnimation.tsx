...
//     password: string;
// }
// export default function LoginInputsAnimation() {
...
//                     className="text-white md:p-6 rounded-lg shadow-lg space-y-4"
//                 >
...
// app/(LogInAndRegister)/login/components/logInInputsAnimation.tsx
"use client";
